...
func GetCachedImageList(imageRepository string, version string, bootstrapper string, arch string) ([]string, error) {
	return images.Kubeadm(imageRepository, version, arch)
}
