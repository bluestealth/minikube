...
```
      ...
      --iso-url strings                   Locations to fetch the minikube ISO from. (default [https://storage.googleapis.com/minikube/iso/minikube-amd64-v1.15.0.iso,https://github.com/kubernetes/minikube/releases/download/v1.15.0/minikube-amd64-v1.15.0.iso,https://kubernetes.oss-cn-hangzhou.aliyuncs.com/minikube/iso/minikube-amd64-v1.15.0.iso])
  ...
  -o, --output string                     Format to print stdout in. Options include: [text,json] (default "text")
      ...
      --target-architecture string        Architecture of target machine
