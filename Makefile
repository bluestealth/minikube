...
test-iso: pkg/minikube/assets/assets.go pkg/minikube/translate/translations.go
	go test -v $(INTEGRATION_TESTS_TO_RUN) --tags=iso --minikube-start-args="--iso-url=file://$(shell pwd)/out/buildroot_$(GOARCH)_efi/output/images/rootfs.iso9660"
